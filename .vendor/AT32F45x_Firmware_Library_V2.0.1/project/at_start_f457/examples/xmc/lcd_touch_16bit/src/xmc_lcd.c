...
/** @addtogroup 457_XMC_lcd_touch_16bit
  * @{
  */
...
void xmc_init(void)
{
  ...
  gpio_pin_mux_config(GPIOC, GPIO_PINS_SOURCE6, GPIO_MUX_10);
  ...
  gpio_init_struct.gpio_pins = GPIO_PINS_2 | GPIO_PINS_4 | GPIO_PINS_5  | GPIO_PINS_6| GPIO_PINS_11| GPIO_PINS_12;
  ...
  gpio_init_struct.gpio_pins =  GPIO_PINS_8 | GPIO_PINS_9  | GPIO_PINS_10 | GPIO_PINS_14 | GPIO_PINS_15;
