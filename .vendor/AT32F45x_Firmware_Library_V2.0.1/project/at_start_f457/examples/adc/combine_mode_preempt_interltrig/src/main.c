...
/** @addtogroup 457_ADC_combine_mode_preempt_interltrig ADC_combine_mode_preempt_interltrig
  * @{
  */

__IO uint16_t adc1_preempt_valuetab[3] = {0};
__IO uint16_t adc2_preempt_valuetab[3] = {0};
__IO uint32_t adc1_preempt_conversion_count = 0;
__IO uint32_t adc2_preempt_conversion_count = 0;
...
static void gpio_config(void)
{
  ...
  gpio_initstructure.gpio_pins = GPIO_PINS_2 |GPIO_PINS_3 |GPIO_PINS_4 | GPIO_PINS_5 | GPIO_PINS_6 | GPIO_PINS_7;
...
static void adc_config(void)
{
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_2, 1, ADC_SAMPLETIME_47_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_3, 2, ADC_SAMPLETIME_47_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_47_5);
  ...
  adc_preempt_channel_set(ADC2, ADC_CHANNEL_5, 1, ADC_SAMPLETIME_47_5);
  adc_preempt_channel_set(ADC2, ADC_CHANNEL_6, 2, ADC_SAMPLETIME_47_5);
  adc_preempt_channel_set(ADC2, ADC_CHANNEL_7, 3, ADC_SAMPLETIME_47_5);
