...
/** @addtogroup 456_CRM_pll_parameter_calculate CRM_pll_parameter_calculate
  * @{
  */
...
/**
  * @brief  system clock config 192mhz
  ...
  * @retval none
  */
void system_clock_config_192mhz(void)
{
  ...
  calculate_status = crm_pll_parameter_calculate(CRM_PLL_SOURCE_HEXT, 192000000, &pll_ms, &pll_ns, &pll_fp);
