...
/** @addtogroup 456_TMR_tmr2_32bit TMR_tmr2_32bit
  * @{
  */

tmr_output_config_type tmr_oc_init_structure;

uint32_t c1dt_val = 0x7ffff;
uint32_t c2dt_val = 0x3ffff;
uint32_t c3dt_val = 0x1ffff;
uint32_t c4dt_val = 0xffff;
...
int main(void)
{
  ...
  tmr_channel_value_set(TMR2, TMR_SELECT_CHANNEL_1, c1dt_val);
  ...
  tmr_channel_value_set(TMR2, TMR_SELECT_CHANNEL_2, c2dt_val);
  ...
  tmr_channel_value_set(TMR2, TMR_SELECT_CHANNEL_3, c3dt_val);
  ...
  tmr_channel_value_set(TMR2, TMR_SELECT_CHANNEL_4, c4dt_val);
