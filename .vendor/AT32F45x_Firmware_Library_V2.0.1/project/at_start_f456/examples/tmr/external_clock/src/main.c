...
/** @addtogroup 456_TMR_external_clock TMR_external_clock
  * @{
  */
...
int main(void)
{
  ...
  tmr2 pwm frequency = apb1_freq/period+1/div+1 = 1 khz
  tmr3 pwm frequency = tmr2 pwm frequency/period+1/div+1 = 10 hz
  ------------------------------------------------------------ */
  /* tmr2 and tmr3 counter mode configuration */

  timerperiod = ((crm_clocks_freq_struct.apb1_freq) / 1000000) - 1;
