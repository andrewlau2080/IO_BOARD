...
/** @addtogroup 456_XMC_sdram_basic
  * @{
  */
...
void sdram_init(void)
{
  ...
  */
  ...
  if(sdram_init_struct.clkdiv == XMC_CLKDIV_1)
  {
    sdclk_mhz = system_core_clock / 1000000;
  }
  else if(sdram_init_struct.clkdiv == XMC_CLKDIV_4)
  {
