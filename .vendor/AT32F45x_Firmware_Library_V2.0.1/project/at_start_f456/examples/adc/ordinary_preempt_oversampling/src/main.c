...
/** @addtogroup 456_ADC_ordinary_preempt_oversampling ADC_ordinary_preempt_oversampling
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_2, 1, ADC_SAMPLETIME_6_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_3, 2, ADC_SAMPLETIME_6_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_6_5);
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_5, 1, ADC_SAMPLETIME_6_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_6, 2, ADC_SAMPLETIME_6_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_7, 3, ADC_SAMPLETIME_6_5);
