...
/** @addtogroup 456_ADC_combine_ordinary_shift_tmr1trgout_dma2 ADC_combine_ordinary_shift_tmr1trgout_dma2
  * @{
  */
...
static void gpio_config(void)
{
  ...
  gpio_initstructure.gpio_pins = GPIO_PINS_2 |GPIO_PINS_5;
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC2, ADC_CHANNEL_5, 1, ADC_SAMPLETIME_6_5);
