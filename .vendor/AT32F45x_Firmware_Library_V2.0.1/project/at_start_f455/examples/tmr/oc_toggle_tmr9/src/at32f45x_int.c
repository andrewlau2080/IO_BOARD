...
/** @addtogroup 455_TMR_oc_toggle_tmr9
  * @{
  */
...
void TMR1_BRK_TMR9_IRQHandler(void)
{
  ...
  if (tmr_interrupt_flag_get(TMR9, TMR_C1_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR9, TMR_SELECT_CHANNEL_1, capture + c1dt_val);
  }
  ...
  if (tmr_interrupt_flag_get(TMR9, TMR_C2_FLAG) != RESET)
  {
    ...
    tmr_channel_value_set(TMR9, TMR_SELECT_CHANNEL_2, capture + c2dt_val);
  }
}
