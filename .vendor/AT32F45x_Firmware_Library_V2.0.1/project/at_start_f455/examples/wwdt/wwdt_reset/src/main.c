...
/** @addtogroup 455_WWDT_wwdt_reset WWDT_wwdt_reset
  * @{
  */
...
int main(void)
{
  ...
  /* enable wwdt
   ...
   timeout = 64 * (32768 / 192000000 ) = 0.0109s
   window  = 16 * (32768 / 192000000 ) = 0.0027s
  ...
  */
  ...
  while(1)
  {
    ...
    /* the reload time must within the window (7ms > 4.4ms) */
    delay_ms(7);
