...
/** @addtogroup 455_ADC_tmr_trigger_automatic_preempted ADC_tmr_trigger_automatic_preempted
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_5, 1, ADC_SAMPLETIME_47_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_6, 2, ADC_SAMPLETIME_47_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_7, 3, ADC_SAMPLETIME_47_5);
