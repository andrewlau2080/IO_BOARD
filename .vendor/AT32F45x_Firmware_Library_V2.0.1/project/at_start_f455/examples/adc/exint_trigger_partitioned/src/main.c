...
/** @addtogroup 455_ADC_exint_trigger_partitioned ADC_exint_trigger_partitioned
  * @{
  */
...
static void exint_config(void)
{
  ...
  scfg_exint_line_config(SCFG_PORT_SOURCE_GPIOB, SCFG_PINS_SOURCE15);
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_2, 1, ADC_SAMPLETIME_24_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_3, 2, ADC_SAMPLETIME_24_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_24_5);
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_5, 1, ADC_SAMPLETIME_24_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_6, 2, ADC_SAMPLETIME_24_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_7, 3, ADC_SAMPLETIME_24_5);
