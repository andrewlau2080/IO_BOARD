...
/** @addtogroup 455_ADC_combine_ordinary_smlt_tmr1trgout2_dma1 ADC_combine_ordinary_smlt_tmr1trgout2_dma1
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_2, 1, ADC_SAMPLETIME_47_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_3, 2, ADC_SAMPLETIME_47_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_47_5);
  ...
  adc_ordinary_channel_set(ADC2, ADC_CHANNEL_5, 1, ADC_SAMPLETIME_47_5);
  adc_ordinary_channel_set(ADC2, ADC_CHANNEL_6, 2, ADC_SAMPLETIME_47_5);
  adc_ordinary_channel_set(ADC2, ADC_CHANNEL_7, 3, ADC_SAMPLETIME_47_5);
