...
/** @addtogroup 455_ADC_use_polling_get_conversion_data ADC_use_polling_get_conversion_data
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 3, ADC_SAMPLETIME_640_5);
