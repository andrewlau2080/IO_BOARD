...
void psram_init(void)
{
  ...
  rw_timing_struct.addr_hold_time      = 0x8;
  rw_timing_struct.addr_setup_time     = 0x9;
  rw_timing_struct.data_setup_time     = 0x1F;
  ...
  w_timing_struct.addr_hold_time      = 0x8;
  w_timing_struct.addr_setup_time     = 0x9;
  w_timing_struct.data_setup_time     = 0x1F;
...
void psram_writebuffer(uint16_t* pbuffer, uint32_t writeaddr, uint32_t numhalfwordtowrite)
{
  for(; numhalfwordtowrite != 0; numhalfwordtowrite--) /*!< while there is data to write */
  {
    ...
    *(__IO uint16_t *) (BANK1_SRAM4_ADDR + writeaddr) = *pbuffer++;
