...
/** @addtogroup 455_IRTMR_output IRTMR_output
  * @{
  */
...
int main(void)
{
  ...
  prescalervalue = (uint16_t) ((crm_clocks_freq_struct.apb1_freq) / 1000000) - 1;

  /* tmr10 time base configuration */
  tmr_base_init(TMR10, 999, prescalervalue);
  ...
  tmr_base_init(TMR11, 99, prescalervalue);
